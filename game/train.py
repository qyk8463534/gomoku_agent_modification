...
class train_network():
    def __init__(self,model=None):
        ...
        self.writer = SummaryWriter('runs/gomoku53s20v20baser')
    ...
    def collect_selfplay_data(self, n_games=1):
        ...
        for i in range(n_games):
            winner, play_data = self.game.self_play_MCTS(self.mcts_player)
    ...
    def policy_evaluate(self, n_games=100,model='./best_policy.model'):
        """
        ...
        total_turn=0
        for i in range(n_games):
            winner,turn = self.game.play(current_mcts_player,pure_mcts_player,start_player=i % 2)
